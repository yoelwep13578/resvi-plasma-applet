...
# LABEL
label_type="icon"
label_icon=""  # Ikon default untuk Swap
label_text="Swap"
label_left_sign="["
label_right_sign="]"
label_dynamic_icon="no"  # Nonaktifkan dynamic icon untuk Swap
...
loadinfo_data_unit="GB-hide-B"  # Konversi data (GB, GiB, GB-hide-B, GiB-hide-B, GiB-hide-iB)
