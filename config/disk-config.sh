...
# LABEL
label_type="icon"
label_icon=""  # Ikon default untuk Disk
label_text="Disk"
label_left_sign="["
label_right_sign="]"
label_dynamic_icon="no"  # Nonaktifkan dynamic icon untuk Disk

# LOAD/CURRENT
loadinfo_fixed_width="4"
loadinfo_text_align="left"
...
# READ TARGET
disk_target="/dev/sda6"  # Target disk/partisi yang akan dimonitor
